# Tutorial on Kalman filter for classification (To publish)
...
Tutorial are written in jupyter notebook. You can read them from Git Hub but if you want to run the code you need to install locally jupyter notebook https://jupyter.org/ and download the tutorial files (.ipynb). The python code of the Tutorial is also available here: https://github.com/marc-h-lambert/Kalman4Classification/.
