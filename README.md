...
## Installation
The code is available in python, we use the standard library and the "scipy" library for optimization : the powell method for the implicit scheme and l-bfgs to compute maximum posterior. If not available on your distribution, you may install scipy following https://www.scipy.org/install.html.
